...
if (Test-Path $dockerComposePath) {
    ...
    $content = $content -replace "backendtemplate-api", "$NewName-api"
    $content = $content -replace "backendtemplate", "$NewName"
    $content = $content -replace "BackendTemplate-API", "$NewName-API"
    $content = $content -replace "backendtemplate-net", "$NewName-net"
