namespace BackendTemplate.API.Config;
...
public static class ServicesConfig
{
    public static void AddConfig(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        // Reemplaza "DefaultConnection" con tu nombre de cadena de conexión
    ...
    private static void AddJwt(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        }).AddJwtBearer(options =>
        {
            ...
            options.TokenValidationParameters = new TokenValidationParameters()
            {
                ...
                ValidIssuer = configuration["Jwt:Issuer"] ?? "BackendTemplate",
                ValidAudience = configuration["Jwt:Audience"] ?? "BackendTemplate",
    ...
    {
        // Ejemplo de cómo vincular configuraciones:
